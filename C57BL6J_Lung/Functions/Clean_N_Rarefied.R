...
Clean_N_Rarefied = function(min_reads, rare_curve){
  ...
  metadata <- metadata %>% select(ID, Microbiome, parasite_strain, mouse_strain, 
  ...
  # Save csv file 
  write.csv2(over_min_reads, "./Checkpoints_Cleaning/Sample_over_min_reads.csv")
  write.csv2(under_min_reads, "./Checkpoints_Cleaning/Sample_under_min_reads.csv")
